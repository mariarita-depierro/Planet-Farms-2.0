 ...
 * 1. Switch per la Dark Mode.
 * 2. messaggio di Feedback al download.
 *
 */
...
if (downloadBtn) {
  downloadBtn.addEventListener("click", () => {
    ...
    message.innerHTML = `
            ...
            <span class="close-message"><i class="bi bi-x"></i></span>
        `;
    ...
    const closeMessage = message.querySelector(".close-message");
