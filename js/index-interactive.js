...
const clickSound = new Audio("../audio/water-sound.mp3");
 ...
 */
function swapImages() {
  const imgElement = document.getElementById("swipe-img");
  ...
  if (imgElement) {
    ...
    console.warn("Elemento 'swipe-img' non trovato in questa pagina!");
  }
}
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const buttonImg = document.getElementById("swipe-img");
